...
$HPSupportAssistant = "AD2F1837.HPSupportAssistant"

$InstalledPackages = Get-AppxPackage -AllUsers | Where-Object {($UninstallPackages -contains $_.Name) -or ($_.Name -match "^$HPidentifier" -and $_.Name -notmatch "^$HPSupportAssistant")}

$ProvisionedPackages = Get-AppxProvisionedPackage -Online | Where-Object {($UninstallPackages -contains $_.DisplayName) -or ($_.DisplayName -match "^$HPidentifier" -and $_.Name -notmatch "^$HPSupportAssistant")}

$InstalledPrograms = Get-Package | Where-Object {$UninstallPrograms -contains $_.Name -and $_.Name -notmatch "^$HPSupportAssistant"}
